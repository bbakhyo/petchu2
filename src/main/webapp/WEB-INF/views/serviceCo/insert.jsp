	...
	<form id="frm" action="insert" method="post"
		...
		<table id="regi">
			...
			<tr>
				...
				<td width=500><input type="text" name="scname"></td>
			</tr>
			<tr>
				...
				<td width=500><input type="text" name="sclicense"></td>
			</tr>
			...
			<tr>
				...
				<td width=500><input type="text" name="sczipcode" size="5"
					...
					type="text" name="scaddress1" size="50" value="${vo.address1}">
					<input type="text" name="scaddress2" size="50" value="${vo.address2}"></td>
			</tr>
				<tr>
				<td class="title" width=100>오픈시간</td>
				<td width=500><input type="opentime" name="opentime"></td>
			</tr>
			<tr>
				<td class="title" width=100>휴식시간</td>
				<td width=500><input type="breaktime" name="breaktime"></td>
			</tr>
			<tr>
				<td class="title" width=100>페점시간</td>
				<td width=500><input type="closetime" name="closetime"></td>
			</tr>
			<tr>
				<td class="title" width=100>업체 설명 <span id="nece"> *</span></td>
				<td width=500><input type="text" name="sconeline"></td>
			</tr>
			<tr>
				<td class="title" width=100>상세설명 <span id="nece"> *</span></td>
				<td width=500><textarea name="scdetail_description" cols="100" span="350" ></textarea></td>
			</tr>
			<tr>
