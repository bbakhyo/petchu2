...
<div id="page">
	...
	<form id="frm" action="insert" method="post"
		...
		<table id="regi">
	 		<tr>
				<td colspan=2><input type="hidden" name="type" value="업체">
			</tr>
			<tr>
			...
			<tr>
				...
				<td width=300><input type="radio" name="gender" value="남">남자
			...
			<tr>
				...
				<td>
				<img src="https://picsum.photos/300/300/" width=150	id="image" width=150>
