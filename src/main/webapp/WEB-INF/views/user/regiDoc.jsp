...
<div id="page">
	...
	<form id="frm" action="insert" method="post"
		...
		<table id="regi">
	 		<tr>
				<td colspan=2><input type="hidden" name="type" value="의사">
		...
		<hr>
		<h1>병원 정보</h1>
			<table id="hospitalregi">
			<tr>
				<td class="title" width=100>병원이름<span id="nece"> *</span></td>
				<td width=500><input type="text" name="dname"></td>
			</tr>
			<tr>
				<td width=100>전화번호<span id="nece"> *</span></td>
				<td width=500>
					<input type="hidden" name="dtel">
					<input type="number" id="dtel1" name="dtel1" placeholder="010" style="width: 50px;"> -
					<input type="number" id="dtel2" placeholder="1234" style="width: 80px;"> -
					<input type="number" id="dtel3" placeholder="1234" style="width: 80px;">
				</td>
			</tr>
			<tr>
				<td class="title" width=100>운영시간<span id="nece"> *</span></td>
				<td width=500>
					<input type="time" name="open"><br>
					<input type="time" name="o_break"><br>
					<input type="time" name="c_break"><br>
					<input type="time" name="close">
				</td>
			</tr>
			<tr>
				<td class="title" width=100>병원정보<span id="nece"> *</span></td>
				<td width=500><textarea cols="80"  rows="5"  name="dinfo"></textarea>
			</tr>
			<tr>
				<td class="title" width=100>병원이미지</td>
				<td>
				<img src="/resources/icon/icon_in_user_img.png" width=150	id="dimage" width=150>
				 <input type="file" name="dimage" style="display:none" id="dimgfile">
				</td>
			</tr>
			<tr>
				<td class="title" width=100>의사라이센스</td>
				<td>
				<img src="/resources/icon/icon_in_user_img.png" width=150	id="dlicense" width=150>
				 <input type="file" name="dlicense" style="display:none" id="dimglicense">
				</td>
			</tr>
			<tr>
				<td class="title" width=100>병원주소</td>
				<td width=500><input type="text" name="dzipcode" size="5"
					value="${vo.zipcode}">
					<button type="button" id="search" class="smallbtn">주소검색</button> <br>
					<input type="text" name="daddress1" size="50" value="${vo.address1}"><br>
					<input type="text" name="daddress2" size="50" value="${vo.address2}"></td>
			</tr>
...
<script>
	...
	$(frm).on("submit", function(e) {
		...
		var strdTel1= $(frm.dtel1).val();
		var strdTel2= $(frm.dtel2).val();
		var strdTel3= $(frm.dtel3).val();
		
		var strdTel=strdTel1+strdTel2+strdTel3;
	...
	$("#dimgfile").on("change", function(e) {
		var file = $("#dimgfile")[0].files[0];
		$("#dimage").attr("src", URL.createObjectURL(file));
	});
	$("#dimglicense").on("change", function(e) {
		var file = $("#dimglicense")[0].files[0];
		$("#dlicense").attr("src", URL.createObjectURL(file));
	});
